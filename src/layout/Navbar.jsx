    ...
    <div>
      ...
      >
        <div className="w-full h-full flex justify-between items-center 2xl:max-w-[110rem] max-w-[85rem] mx-auto">
          <div className="items-center hidden space-x-2 md:flex md:space-x-10">
            <h1 className="text-4xl font-bold xl:text-4xl lg:text-3xl ">
              BOLU
            </h1>
          </div>
          ...
          <ul className="items-center hidden space-x-10 md:flex">
            ...
            <li className="headerLink">
              <a href="https://medium.com/@adetifaboluwatife" target="_">Blog</a>
            </li>
            ...
            <a
              ...
              target="_blank"
            >
              <a class="relative inline-flex items-center justify-center px-6 py-3 overflow-hidden font-bold text-white rounded-md shadow-2xl group">
        ...
        <div className="flex items-center justify-between space-x-2 md:hidden md:space-x-10">
          <h1 className="text-4xl font-bold xl:text-4xl lg:text-3xl ">BOLU</h1>
