  ...
  return (
    <div id="about" className="bg-black">
      ...
      <AnimatePresence exitBeforeEnter>
        <div className="w-full h-[49rem] relative lg:hidden flex py-10 mt-32 bg-black text-white">
        ...
        <div className="w-full h-full lg:flex items-center justify-center">
          <div className="w-full h-[59rem] max-w-[40rem] relative lg:flex hidden py-10 pt-20 bg-black text-white">
            <div className="w-full h-full  ">
              <div className="w-full h-40 ">
                <motion.h1
                  initial={{ y: 20, opacity: 0 }}
